...
# Returns tuple with the schools, faculties and links
def obtainFacultiesSchools():
    ...
    return (faculties_and_schools, faculties_and_schools_href)

# Obtains the JSON object
def createJSON(faculties_and_schools, faculties_and_schools_href):
...
def main():
    (fac_schools,hr) = obtainFacultiesSchools()
    json_object = createJSON(fac_schools, hr)
